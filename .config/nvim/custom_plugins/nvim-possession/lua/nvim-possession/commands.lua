...
local core = require("nvim-possession.core")
  ...
  end,
    {
      ...
      complete = function(_, cmdLine)
        vim.tbl_filter(function(key)
          if require("nvim-possession.init")._excluded_meta[key] then
            return false
          end
          return true
        end, vim.tbl_keys(require("nvim-possession.init")))

        local available_commands = vim.tbl_keys(require("nvim-possession.init"))
