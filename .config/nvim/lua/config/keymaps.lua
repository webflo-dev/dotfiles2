...
map("n", "<M-h>", "<cmd>resize +2<cr>", { desc = "Increase window height" })
map("n", "<M-l>", "<cmd>resize -2<cr>", { desc = "Decrease window height" })
map("n", "<M-j>", "<cmd>vertical resize -2<cr>", { desc = "Decrease window width" })
map("n", "<M-k>", "<cmd>vertical resize +2<cr>", { desc = "Increase window width" })
